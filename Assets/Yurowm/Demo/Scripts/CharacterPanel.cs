...
public class CharacterPanel : MonoBehaviour {
	...
	Actions actions;
	PlayerControllerYurowm controller;
	Camera[] cameras;
	...
	void Initialize () {
		...
		controller = character.GetComponent<PlayerControllerYurowm> ();

		foreach (PlayerControllerYurowm.Arsenal a in controller.arsenal)
