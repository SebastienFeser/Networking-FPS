...
public class OldPlayerController : MonoBehaviourPunCallbacks
{
    ...
    void SpawnBall(Vector3 position, Vector3 velocity, int ownerActorNumber)
    {
        ...
        ballInstantiated.GetComponent<OldBallShoot>().shooterActorNumber = ownerActorNumber;
